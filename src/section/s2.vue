<template>
  <article class="s2 relative" id="s2">
    ...
    <div class="building">
      <img src="./s2/building.png" alt="building" data-aos="fade-up" data-aos-delay="3">
    </div>
    <div class="b_text font-['Noto_sans_tc'] text-[#fff]">半屏山 情境示意圖</div>
  </article>
</template>
